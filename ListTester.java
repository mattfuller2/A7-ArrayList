...
public class ListTester {
	...
	private static final Integer ELEMENT_Z = new Integer(-2);// element that should appear in no
																// lists
	private static final Scenario<Integer> ABC_IterRemoveA_BC = null;
	private static final Scenario<Integer> AB_add0C_CAB = null;
	private static final Scenario<Integer> AB_addToFrontC_CAB = null;
	...
	private void runTests() {
		...
		testTwoElementList(A_add0B_B, "A_add0B_BA", LIST_BA, STRING_BA);
	...
	private void testEmptyList(Scenario<Integer> scenario, String scenarioName) {
		...
		try {
			...
			printTest(scenarioName + "_testRemoveIndex", testRemoveIndex(scenario.build(), 1, null, Result.IndexOutOfBounds));
			// Iterator
	...
	private void testThreeElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_iterNextNext_testIterNext", testIterNext((iterAfterNext(scenario.build(), 2)), contents[0], Result.MatchingValue));
			printTest(scenarioName + "_iterNextNext_testIterRemove", testIterRemove(iterAfterNext(scenario.build(), 2), Result.NoException));
			...
			printTest(scenarioName + "_iterNextRemoveNext_testIterHasNext", testIterRemove(iterAfterRemove(iterAfterNext(scenario.build(), 2)), Result.IllegalState));
			printTest(scenarioName + "_iterNextRemoveNext_testIterNext", testIterRemove(iterAfterRemove(iterAfterNext(scenario.build(), 2)), Result.MatchingValue));
			printTest(scenarioName + "_iterNextRemoveNext_testIterRemove", testIterRemove(iterAfterRemove(iterAfterNext(scenario.build(), 2)), Result.NoException));

			printTest(scenarioName + "_iterNextNextRemoveNext_testIterHasNext", testIterRemove(iterAfterRemove(iterAfterNext(scenario.build(), 2)), Result.IllegalState));
			printTest(scenarioName + "_iterNextNextRemoveNext_testIterNext", testIterRemove(iterAfterRemove(iterAfterNext(scenario.build(), 2)), Result.IllegalState));
			printTest(scenarioName + "_iterNextNextRemoveNext_testIterRemove", testIterRemove(iterAfterRemove(iterAfterNext(scenario.build(), 2)), Result.IllegalState));

			printTest(scenarioName + "_iterNextNextNext_testIterHasNext", testIterRemove(iterAfterRemove(iterAfterNext(scenario.build(), 2)), Result.IllegalState));
			printTest(scenarioName + "_iterNextNextNext_testIterNext", testIterRemove(iterAfterRemove(iterAfterNext(scenario.build(), 2)), Result.IllegalState));
			printTest(scenarioName + "_iterNextNextNext_testIterRemove", testIterRemove(iterAfterRemove(iterAfterNext(scenario.build(), 2)), Result.IllegalState));

			printTest(scenarioName + "_iterNextNextNextRemove_testIterHasNext", testIterRemove(iterAfterRemove(iterAfterNext(scenario.build(), 2)), Result.IllegalState));
			printTest(scenarioName + "_iterNextNextNextRemove_testIterNext", testIterRemove(iterAfterRemove(iterAfterNext(scenario.build(), 2)), Result.IllegalState));
			printTest(scenarioName + "_iterNextNextNextRemove_testIterRemove", testIterRemove(iterAfterRemove(iterAfterNext(scenario.build(), 2)), Result.IllegalState));
